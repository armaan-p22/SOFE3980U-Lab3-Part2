...
public class Binary
{
    ...
    */
    public static Binary or(Binary num1,Binary num2)
    {
        ...
        for(int i=0;i<len;i++)
        {
            char a = (i<len1)? num1.number.charAt(len1-1-i):'0';
            char b = (i<len2)? num2.number.charAt(len2-1-i):'0';
            num3 = ((a=='1' || b=='1')? "1":"0")+num3;
        }
    ...
    */
    public static Binary multiply(Binary num1,Binary num2)
    {
        ...
        Binary temp=num1; // This holds num1 shifted left
        for(int i=num2.number.length()-1;i>=0;i--)
        {
            ...
            temp=add(temp,temp); // shift left by adding to itself (doubling)
        }
        return result;
    }
}